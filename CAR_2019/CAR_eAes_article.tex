...
\Ueberschrift{The importance of standardization} {the importance of standardization}
\vspace{0.1cm}
...
\Ueberschrift{Published attacks on \textsc{AES}}{published attacks on AES}
\vspace{0.1cm}
...
\Ueberschriftu{Mathematical structure of \textsc{AES}}
\noindent
...
\Ueberschriftu{Attacks performed on binary devices}
\noindent
...
\Ueberschriftu{Quantum algebraic attack}
\noindent
...
\Ueberschrift{\textsc{Rijndael}, the base of \textsc{eAES}}{Rijndael, the base of eAES}
\vspace{0.1cm}
...
\Ueberschriftu{Computation grounds}
\noindent
...
\Ueberschriftu{\textsc{Rijndael} algorithm architecture}
\noindent
...
\Ueberschriftu{Basic \textsc{Rijndael} encryption functions}
...
\Ueberschrift{Modifications for \textsc{eAES}}{modifications for eAES}
\noindent
...
\Ueberschriftu{\textsc{Rijndael} inheritance}
\noindent
...
\Ueberschriftu{Say goodbye to 128- and 192-bit keys}
\noindent
...
\Ueberschriftu{Replacing \textit{ExpandKey}}
\noindent
...
\Ueberschriftu{Pseudo Random Number Generators}
\noindent
...
\Ueberschriftu{Algorithm architecture}
\noindent
...
\Ueberschriftu{Quantum resources and graph theory}
\noindent
...
\Ueberschriftu{Quantum resources for the search}
\noindent
...
\Ueberschriftu{Quantum resources for the ciphers}
\noindent
...
\Ueberschrift{Impact of Quantum Algebraic Attacks}{quantum algebraic attacks}
\vspace{0.1cm}
